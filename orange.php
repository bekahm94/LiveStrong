		...
		<nav class="navbar navbar-default">
            ...
            <div class="dish">
                <div class="dish-header">
                        <img class="img-responsive" src="images/orange-header.jpg">
                </div>
            <div class="nutrional">
                <div class="container">
                ...
                <div class="info">
                    <div class="container">
                        ...
                        <br><br>
                        <h1>Orange & blueberry Bircher</h1>
                    </div>
                        <hr>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="ingredients">
                                ...
                                <ul>
                                    ...
                                    <br>
                                    <li>2 tbsp golden linseeds</li>
                                    <br>
                                    <li>zest of ½ an orange</li>
                                    <br>
                                    <li>¾ of a 175g tub yogurt</li>
                                    <br>
                                    <li>2 peeled and chopped oranges</li>
                                    <br>
                                    <li>4 handfuls blueberries from a 150g pack</li>
                                    <br>
			...
			<div class="method">
                            <h2>Method</h2>
                            <h3>1.</h3><p>Mix 70g oats and 2 tbsp golden linseeds with the zest of 1 /2 an orange. Pour over 300ml boiling water 
                                and leave overnight. The next day, stir in three-quarters of a 175g tub of yogurt, spoon into glasses or bowls, 
                                top with 2 peeled and chopped oranges, the remaining yogurt and 4 handfuls blueberries from a 150g pack</p>
                        </div>
                    </div>
                </div>
          </div>
