		...
		<nav class="navbar navbar-default">
            ...
            <div class="dish">
                <div class="dish-header">
                    <img class="img-responsive" src="images/wrap-header.jpg">
                </div>
            <div class="nutrional">
                <div class="container">
                    ...
                    <div class="container">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="ingredients">
                                ...
                                <br>
                                <ul>
                                    <li>½ x 300g pack Quorn chicken-style pieces (or similar vegetarian product), sliced at an angle</li>
                                    <br>
                                    ...
                                    <br>
                                    <li>few sprigs coriander, chopped</li>
			...
			<div class="method">
                            <h2>Method</h2>
                            <h3>1.</h3><p>Mix the vegetarian, chicken-style pieces with the lime juice, chilli powder and garlic.</p>
				<h3>2.</h3><p>Heat the oil in a non-stick frying pan then fry the pieces for a couple of mins, 
                                    while you warm the wraps following the pack instructions or if you have a gas hob, heat them 
                                    over the flame to slightly char them. Do not let them dry out or they are difficult to roll.</p>
				<h3>3.</h3><p>Squash half an avocado onto each wrap, add the peppers to the pan to warm them through 
                                    then pile onto the wraps with the chicken-style pieces, and sprinkle over the coriander. Roll up, 
                                    cut in half and eat with your fingers.</p>
                        </div>
                    </div>
                </div>
          </div>
