		...
		<nav class="navbar navbar-default">
            ...
            <div class="dish">
                <div class="dish-header">
                        <img class="img-responsive" src="images/narvin-header.jpg">
                </div>
            <div class="nutrional">
                <div class="container">
                    ...
                    <div class="container">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="ingredients">
                                ...
                                <br>
                                <ul>
                                    <li>900g lean lamb fillets or leg steaks, all visible fat removed.</li>
                                    <br>
                                    <li>200g baby carrots, peeled and halved</li>
                                    <br>
			...
			<div class="method">
                            <h2>Method</h2>
                            <h3>1.</h3><p>Place all the ingredients into the slow cooker pot, season and stir.</p>
                            <h3>2.</h3><p>Cover and cook for 6-8 hours on MEDIUM or until the meat is tender.</p>
                            <h3>3.</h3><p>Remove the cinnamon sticks and bay leaves and serve garnished with chopped parsley.</p>
                        </div>
                    </div>
                </div>
          </div>
