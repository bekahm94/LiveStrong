		...
		<nav class="navbar navbar-default">
            ...
            <div class="dish">
                <div class="dish-header">
                        <img class="img-responsive" src="images/tabb-header.jpg">
                </div>
            <div class="nutrional">
                <div class="container">
                    ...
                    <div class="container">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="ingredients">
                                ...
                                <br>
                                <ul>
                                    <li>100g dried quinoa</li>
                                    <br>
                                    <li>75g parsley, roughly chopped</li>
                                    <br>
                                    <li>300g tomatoes, cut into 1cm dice (no need to remove the seeds)</li>
                                    <br>
                                    <li>100g cucumber, cut into small dice</li>
                                    <br>
                                    ...
                                    <br>
                                    <li>drop of vanilla extract</li>
                                    <br>
                                    <li>1 tsp rice syrup or agave</li>
                                    <br>
                                    <li>pinch of Himalayan pink salt</li>
                                    <br>
                                    <li>½ garlic clove, crushed</li>
                                    <br>
                                    <li>50g salad leaves, to serve</li>
                                </ul>
                            </div>
                        </div>
			...
			<div class="method">
                            <h2>Method</h2>
                            <h3>1.</h3><p>Cook the quinoa following pack instructions, then set aside to cool.</p>
				<h3>2.</h3><p>Make the dressing by adding the olive oil, vinegar, lemon juice, vanilla 
                                    extract, rice syrup, pinch of salt and garlic into a jug and whisk until smooth. 
                                    Mix this into the quinoa and mix together with all the other ingredients. Serve 
                                    on a bed of salad leaves.</p>
                        </div>
                    </div>
                </div>
          </div>
