		...
		<nav class="navbar navbar-default">
            ...
            <div class="dish">
                <div class="dish-header">
                        <img class="img-responsive" src="images/kale-header.jpg">
                </div>
            <div class="nutrional">
                <div class="container">
                ...
                <div class="info">
                    <div class="container">
                        ...
                        <br><br>
                        <h1>Broccoli and kale green soup</h1>
                    </div>
                        <hr>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="ingredients">
                                ...
                                <br>
                                <ul>
                                    <li>500ml stock, made by mixing 1 tbsp bouillon powder and boiling water in a jug</li>
                                    <br>
                                    <li>1 tbsp sunflower oil</li>
                                    <br>
                                    <li>2 garlic cloves, sliced</li>
                                    <br>
                                    <li>thumb-sized piece ginger, sliced</li>
                                    <br>
                                    <li>½ tsp ground coriander</li>
                                    <br>
                                    <li>3cm/1in piece fresh turmeric root, peeled and grated, or ½ tsp ground turmeric</li>
                                    <br>
                                    <li>pinch of pink Himalayan salt</li>
                                    <br>
                                    <li>200g courgettes, roughly sliced</li>
                                    <br>
                                    <li>85g broccoli</li>
                                    <br>
                                    <li>100g kale, chopped</li>
                                    <br>
                                    <li>1 lime, zested and juiced</li>
                                    <br>
                                    <li>small pack parsley, roughly chopped, reserving a few whole leaves to serve</li>
                                </ul>
                            </div>
                        </div>
			...
			<div class="method">
                            <h2>Method</h2>
                            <h3>1.</h3><p>Put the oil in a deep pan, add the garlic, ginger, coriander, turmeric and salt, fry on a 
                                medium heat for 2 mins, then add 3 tbsp water to give a bit more moisture to the spices.</p>
				<h3>2.</h3><p>Add the courgettes, making sure you mix well to coat the slices in all the spices, and 
                                    continue cooking for 3 mins. Add 400ml stock and leave to simmer for 3 mins.</p>
				<h3>3.</h3><p>Add the broccoli, kale and lime juice with the rest of the stock. Leave to cook again 
                                    for another 3-4 mins until all the vegetables are soft.</p>
                                <h3>4.</h3><p>Take off the heat and add the chopped parsley. Pour everything into a blender and blend 
                                    on high speed until smooth. It will be a beautiful green with bits of dark speckled through (which is the kale). 
                                    Garnish with lime zest and parsley.</p>
                        </div>
                    </div>
                </div>
          </div>
