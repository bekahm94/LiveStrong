		...
		<nav class="navbar navbar-default">
            ...
            <div class="dish">
                <div class="dish-header">
                    <img class="img-responsive" src="images/threegrain-header.jpg">
                </div>
            <div class="nutrional">
                <div class="container">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="ingredients">
                                ...
                                <ul>
                                    <li>300g oatmeal</li>
                                    <br>
                                    <li>300g spelt flakes</li>
                                    <br>
                                    <li>300g barley flakes</li>
                                    <br>
                                    <li>Agave nectar and sliced strawberries, to serve (optional)</li>
                                </ul>
                            </div>
                        </div>
			...
			<div class="method">
                            <h2>Method</h2>
                            <h3>1.</h3><p>Working in batches, toast the oatmeal, spelt flakes and barley in a large, dry 
                                frying pan for 5 mins until golden, then leave to cool and store in an airtight container.</p>
				...
				<h3>3.</h3><p>When you want to eat it, simply combine 50g of the porridge mixture in a saucepan 
                                    with 300ml milk or water. Cook for 5 mins, stirring occasionally, then top with a drizzle of honey 
                                    and strawberries, if you like (optional). Will keep for 6 months.</p>
                        </div>
                    </div>
                </div>
          </div>
