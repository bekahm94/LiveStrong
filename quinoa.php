		...
		<nav class="navbar navbar-default">
            ...
            <div class="dish">
                <div class="dish-header">
                        <img class="img-responsive" src="images/quinoa-header.jpg">
                </div>
            <div class="nutrional">
                <div class="container">
                ...
                <div class="info">
                    <div class="container">
                        ...
                        <br><br>
                        <h1>Cardamom & peach quinoa porridge</h1>
                    </div>
                        <hr>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="ingredients">
                                ...
                                <ul>
                                    <li>75g quinoa</li>
                                    <br>
                                    <li>25g porridge oats</li>
                                    <br>
                                    <li>4 cardamom pods</li>
                                    <br>
                                    <li>250ml unsweetened almond milk</li>
                                    <br>
                                    <li>2 ripe peaches, cut into slices</li>
                                    <br>
			...
			<div class="method">
                            <h2>Method</h2>
                            <h3>1.</h3><p>Put the quinoa, oats and cardamom pods in a small saucepan with 250ml water and 100ml of the almond milk. 
                                Bring to the boil, then simmer gently for 15 mins, stirring occasionally.</p>
				<h3>2.</h3><p>Pour in the remaining almond milk and cook for 5 mins more until creamy.</p>
				<h3>3.</h3><p>Remove the cardamom pods, spoon into bowls or jars, and top with the peaches and maple syrup.</p>
                        </div>
                    </div>
                </div>
          </div>
